...
namespace OwcaScript::Internal {
	...
	bool AstExprCompare::execute_compare(OwcaVM vm, CompareKind kind, OwcaValue left, OwcaValue right)
	{
		if (kind == CompareKind::Is) {
			...
			case OwcaValueKind::Range: return left.as_range_certainly().lower() == right.as_range_certainly().lower() && left.as_range_certainly().upper() == right.as_range_certainly().upper() && left.as_range_certainly().step() == right.as_range_certainly().step();
			case OwcaValueKind::Bool: return left.as_bool_certainly() == right.as_bool_certainly();
			case OwcaValueKind::Float: return left.as_float_certainly() == right.as_float_certainly();
			case OwcaValueKind::String: return compare(vm, CompareKind::Eq, left, right) == Result::True;
			case OwcaValueKind::Functions: return left.as_functions_certainly().internal_value() == right.as_functions_certainly().internal_value() && left.as_functions_certainly().internal_self_object() == right.as_functions_certainly().internal_self_object();
			case OwcaValueKind::Map: return left.as_map_certainly().internal_value() == right.as_map_certainly().internal_value();
			case OwcaValueKind::Class: return left.as_class_certainly().internal_value() == right.as_class_certainly().internal_value();
			case OwcaValueKind::Object: return left.as_object_certainly().internal_value() == right.as_object_certainly().internal_value();
			case OwcaValueKind::Array: return left.as_array_certainly().internal_value() == right.as_array_certainly().internal_value();
			case OwcaValueKind::Tuple: return left.as_tuple_certainly().internal_value() == right.as_tuple_certainly().internal_value();
			case OwcaValueKind::Set: return left.as_set_certainly().internal_value() == right.as_set_certainly().internal_value();
			case OwcaValueKind::Iterator: return left.as_iterator_certainly().internal_value() == right.as_iterator_certainly().internal_value();
			case OwcaValueKind::Exception: return left.as_exception_certainly().internal_owner() == right.as_exception_certainly().internal_owner();
			case OwcaValueKind::Namespace: return left.as_namespace_certainly().internal_value() == right.as_namespace_certainly().internal_value();
